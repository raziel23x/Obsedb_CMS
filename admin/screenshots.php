...
require_once( '../sources/adminScreenshotsClass.php' );
...
if ($_REQUEST['do'] == 'Delete Screenshot') {
    ...
    $path = str_replace( "/admin/screenshots.php", "/", $path );
...
if ($_REQUEST['do'] == 'upload')
{
    ...
    $aCurBasePath = str_replace( "/admin", "/media/screenshots/", $aCurBasePath );
