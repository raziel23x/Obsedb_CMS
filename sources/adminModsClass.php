...
function manage_Mods()
{
	...
	if ( isset($_REQUEST['s']) && ($_REQUEST['s'] != '') )
	{
		...
		while ( $row = $latestMod->FetchNextObject() )
		{
			...
			if ($row->PUBLISHED == 0)
			{
				echo " <a href='Mods.php?do=publish&id=$row->ID'><img src='../images/admin/unpublished.jpg' border='0'></a> &nbsp;";
			}
			if ($row->PUBLISHED == 1)
			{
				echo " <a href='Mods.php?do=unpublish&id=$row->ID'><img src='../images/admin/published.jpg' border='0'></a> &nbsp;";
			}
...
class Module {
	...
	function delete_Mod()
	{
        ...
        $path = str_replace( "/admin/Mods.php", "/", $path );
